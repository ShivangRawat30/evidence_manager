...
export const MenuOverlay: React.FC<{ toggle: () => void }> = ({ toggle }) => {
	...
	return (
		<div
			className="menu fixed bg-black h-screen w-screen top-0 left-0 text-white px-8 md:px-24 lg:px-32 py-12 flex flex-col"
			ref={container}>
			...
			<div className="title h-full w-full flex items-center justify-center text-[40vw] text-white/5 absolute top-0 left-0 z-0 cursor-default select-none">
